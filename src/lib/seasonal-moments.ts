...
export const SEASONAL_MOMENTS: SeasonalMoment[] = [
  ...
  },
  {
    ...
    label: "Matiti Run Moorea — trail & course nature",
    href: "/evenements",
    icon: "trophy",
    accent: "sport",
  },
  {
    ...
    label: "Pâques & pont — marchés & sorties famille",
    href: "/evenements",
    icon: "calendar",
    accent: "fetes",
  },
  {
    ...
    label: "Fête de la musique — concerts & scènes ouvertes",
    href: "/evenements",
    icon: "music",
    accent: "heiva",
  },
  {
    id: "fete-autonomie-2026",
    priority: 70,
    start: "2026-06-27",
    end: "2026-06-30",
    label: "Fête de l’Autonomie (29 juin) — communes & culture",
    href: "/evenements",
    icon: "sparkles",
    accent: "fetes",
  },
  {
    ...
    label: "14 juillet — animations & feux d’artifice",
    href: "/evenements",
    icon: "sparkles",
    accent: "fetes",
  },
  {
    ...
    label: "Hawaiki Nui Va’a — la grande course de pirogue",
    href: "/evenements",
    icon: "waves",
    accent: "ocean",
  },
  {
    ...
    label: "Toussaint — fleurs, cimetières & famille",
    href: "/evenements",
    icon: "calendar",
    accent: "agenda",
  },
